    ...
    <div className='form-div info-div'>
      ...
      <div className='upload-div personal-info-div'>
        <div>
          ...
          <label htmlFor="yes-no" className='info-label add-questions-label'>Please tell me about yourself in less than 500 words</label>
        ...
        <div>
          ...
          <label htmlFor="dropdown" className='info-label add-questions-label'>Please select the year of graduaion from the list below</label>
          <input type="text" id="dropdown" name="dropdown" className='info-input'/>
        </div>
        ...
        <div>
          ...
          <label htmlFor="yes-no" className='info-label add-questions-label'>Have you ever been rejected by the UK embassy?</label>
          <input type="text" id="yes-no" name="yes-no" className='info-input'/>
        </div>
